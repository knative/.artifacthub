...
You can download the latest binaries from the [Releases](https://github.com/knative-extension/kn-plugin-quickstart/releases) page.
...
``` bash
git clone git@github.com:knative-extension/kn-plugin-quickstart.git
